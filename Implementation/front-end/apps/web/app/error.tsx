    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <GlassCard className="max-w-md p-12 text-center">
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          <Button onClick={reset} variant="primary" size="sm">重试</Button>
          <a href="/" className="text-sm font-medium text-accent-green hover:text-accent-green-light transition-colors">
            返回首页
          </a>
        </div>
      </GlassCard>
